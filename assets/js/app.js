...
const App = {
      ...
      <div class="topbar">
        <div class="topbar-inner">
          <div class="brand" style="cursor:pointer" onclick="App.navigate('${user ? '/dashboard' : '/welcome'}')">
            ...
            <span>CAIE Practice<br><small>USAII &middot; Certified AI Examiner</small></span>
          </div>
  ...
  footer() {
    return `<div class="footer-note">CAIE PRACTICE ENGINE &middot; ${QUESTION_BANK.length} QUESTIONS &middot; RUNS ENTIRELY IN YOUR BROWSER</div>`;
  },
